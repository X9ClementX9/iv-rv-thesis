...
📄 **[Read the thesis (PDF)](thesis.pdf)** &nbsp;·&nbsp; 🧪 [Code in `Python Project/`](Python%20Project) &nbsp;·&nbsp; 🐍 [Pipeline orchestrator](Python%20Project/src/analysis/run_all_analysis.py)

## Repository layout

```
.
├── thesis.tex                # LaTeX source (report class, natbib, listings)
...
│   └── fig_iv_rv_scatter.pdf       # generated by figures.py
