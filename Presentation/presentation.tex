...
\begin{frame}[plain]
  \vspace*{10mm}
  \begin{center}
    {\fontsize{34}{40}\selectfont\sffamily\bfseries\color{navy}Thank you.}\\[3mm]
    {\large\itshape Questions?}
  \end{center}
  \vspace*{14mm}
  \begin{center}
    \includegraphics[width=24mm]{../media/qr_repo.png}\\[3mm]
    {\small\bfseries Replication materials}\\[1mm]
    {\small\href{https://github.com/X9ClementX9/iv-rv-thesis}{\texttt{github.com/X9ClementX9/iv-rv-thesis}}}\\[2mm]
