...
\setbeamertemplate{footline}{%
  \hfill\textcolor{midgrey}{\tiny G.~Torres \& C.~Massabo --- MSc FMI --- May 2025 \quad
...
% =====================================================================
% SLIDE 7 - FIRST LOOK (TRANSITION)
% =====================================================================
\begin{frame}{A first look at the data}
  \vspace*{2mm}
  \begin{center}
    \includegraphics[width=0.86\textwidth]{../media/fig_iv_rv_timeline.pdf}
  \end{center}
  \vspace*{1mm}
  \begin{center}
    {\footnotesize\itshape Red shading marks stress days
      (90th-percentile thresholds set ex~ante).}
  \end{center}
\end{frame}
...
\begin{frame}{Headline result}
  ...
  \begin{center}
    ...
    {\fontsize{72}{80}\selectfont\color{navy}\textbf{$\hat\beta = 0.97$}}

    \vspace*{4mm}
    {\large S\&P~500 \,---\, normal regime \,---\, $N = 955$}
...
\begin{frame}{Why? Three economic mechanisms}
  ...
  \begin{enumerate}
    ...
    \item \textbf{Hedging demand.} Equity investors buy out-of-the-money puts in stress \,---\, pushes the VIX above expected realized volatility.
    \item \textbf{24/7 trading.} Bitcoin realized volatility adjusts to news within hours, not days \,---\, compresses the wedge faster.
...
\begin{frame}{What we don't claim}
  ...
  \begin{itemize}
    ...
    \item \textbf{Aggregated indices.} No full option surface \,---\, no skew, no term structure.
...
\begin{frame}{Take-aways}
  ...
  \begin{enumerate}
    ...
    \item The variance risk premium \textbf{widens in equity stress} and \textbf{compresses in crypto stress} \,---\, a feature only visible cross-market.
  \end{enumerate}
  \vspace*{8mm}
  \begin{center}
...
\begin{frame}[plain]
  \vspace*{18mm}
  \begin{center}
    {\fontsize{40}{48}\selectfont\sffamily\bfseries\color{navy}Thank you.}\\[4mm]
    {\Large\itshape Questions?}
  \end{center}
  \vspace*{10mm}
  \begin{center}
    \begin{tabular}{c@{\hspace{14mm}}c}
      \includegraphics[width=28mm]{../media/qr_repo.png} &
      \begin{minipage}[c]{0.45\textwidth}\small
        \textbf{Replication materials} \\[2pt]
        \href{https://github.com/X9ClementX9/iv-rv-thesis}{\texttt{github.com/X9ClementX9/}}\\
        \href{https://github.com/X9ClementX9/iv-rv-thesis}{\texttt{iv-rv-thesis}}\\[3pt]
        {\footnotesize\itshape Thesis, source code, dataset and HAC estimation routines.}
      \end{minipage}
    \end{tabular}
  \end{center}
\end{frame}
