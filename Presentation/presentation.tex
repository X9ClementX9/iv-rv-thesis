...
\begin{frame}[plain]
  \begin{center}
    \vspace*{3mm}
    \includegraphics[width=0.45\textwidth]{../Thesis/media/image1.png}\\[6mm]
    ...
    \vspace*{8mm}
    \textcolor{navy}{\rule{0.55\textwidth}{0.6pt}}
    \vspace*{5mm}
...
% Footline removed locally: the figure + bullets fill the frame
% =====================================================================
{\setbeamertemplate{footline}{}
\begin{frame}{A first look: Bitcoin}
  \vspace*{3mm}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{../Thesis/media/fig_iv_rv_timeline_btc.pdf}
  \end{center}
  \vspace*{3mm}
  \begin{itemize}
...
% =====================================================================
% SLIDE 7b - FIRST LOOK: S&P 500 (footline removed for same reason)
% =====================================================================
{\setbeamertemplate{footline}{}
\begin{frame}{A first look: S\&P~500}
  \vspace*{3mm}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{../Thesis/media/fig_iv_rv_timeline_spx.pdf}
  \end{center}
  \vspace*{3mm}
  \begin{itemize}
...
\begin{frame}[plain]
  ...
  \vspace*{8mm}
  \begin{center}
    \includegraphics[width=20mm]{../Thesis/media/qr_repo.png}\\[2mm]
